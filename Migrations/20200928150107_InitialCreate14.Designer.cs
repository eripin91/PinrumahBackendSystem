...
namespace PinBackendSystem.Migrations
{
    ...
    [Migration("20200928150107_InitialCreate14")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Feature", b =>
                {
                    ...
                    b.Property<int?>("Listing_featureId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Feature", b =>
                {
                    b.HasOne("PinBackendSystem.Models.Listing_feature", "Listing_feature")
                        .WithMany("Features")
                        .HasForeignKey("Listing_featureId");
                });

            modelBuilder.Entity("PinBackendSystem.Models.Listing_feature", b =>
                {
                    b.HasOne("PinBackendSystem.Models.Listing", "listings")
                        .WithOne("Listing_feature")
                        .HasForeignKey("PinBackendSystem.Models.Listing_feature", "ListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
