...
namespace PinBackendSystem.Migrations
{
    ...
    [Migration("20201119065501_InitialCreate40")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Kecamatan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Kota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Kecamatan", b =>
                {
                    b.HasOne("PinBackendSystem.Models.Kota", "Kota")
                        .WithMany("Kecamatan")
            ...
            modelBuilder.Entity("PinBackendSystem.Models.Listing", b =>
                {
                    b.HasOne("PinBackendSystem.Models.Kecamatan", "Kecamatan")
                        .WithOne("Listing")
                        .HasForeignKey("PinBackendSystem.Models.Listing", "KecamatanId");

                    b.HasOne("PinBackendSystem.Models.Kota", "Kota")
                        .WithOne("Listing")
                        .HasForeignKey("PinBackendSystem.Models.Listing", "KotaId");
                });
